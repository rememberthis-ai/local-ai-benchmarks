...
| [`swiftlm-cold-start-ramp-up.md`](swiftlm-cold-start-ramp-up.md) | First real SwiftLM request after load is 3×+ slower than steady-state (Metal JIT compile) — a trivial warmup ping doesn't fully fix it |
